...

{
  ...
  "key_vocabulary": ["List up to 8 specific Filipino or subject-specific words from the actual visible text that a ${grade} struggling reader would benefit from learning. These must be words actually present in the image, not generic words for the topic. For Math/Science, list key terms. Empty array if none found."],
  "content_summary": "One sentence describing what this material is about, written as if explaining to a teacher. Max 25 words.",
  "focus_area": "The single most important thing for a struggling ${grade} reader to learn from this material. Be specific. Max 20 words.",
